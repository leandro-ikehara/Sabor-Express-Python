...
cliente1 = Cliente(nome='Alice'.ljust(10), idade=25, email='alice@gmail.com'.ljust(20), telefone='123-456-7890')
cliente2 = Cliente(nome='Bob'.ljust(10), idade=30, email='bob@gmail.com'.ljust(20), telefone='987-654-3210')
cliente3 = Cliente(nome='Charlie'.ljust(10), idade=22, email='charlie@gmail.com'.ljust(20), telefone='555-123-4567')
